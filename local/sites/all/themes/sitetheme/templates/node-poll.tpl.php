...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"><div class="node-inner">
  ...
  <?php
    ...
    if ($user->uid == 0) {
      ...
      print t('<a href="@login">Login</a> or <a href="@register">register</a> to vote on polls', array('@login' => url('user/login', array('query' => $destination)), '@register' => url('user/register', array('query' => $destination))));
    }
  ?>
  </div>
